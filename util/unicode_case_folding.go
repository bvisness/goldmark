...
func init() {
	unicodeCaseFoldings = make(map[rune][]rune, len(unicodeCaseFoldingsList))
	for _, folding := range unicodeCaseFoldingsList {
		unicodeCaseFoldings[folding.Before] = folding.After
	}
}

type unicodeCaseFolding struct {
	Before rune
	After  []rune
}

var unicodeCaseFoldingsList = [...]unicodeCaseFolding{
	{0x41, []int32{97}},
	{0x42, []int32{98}},
	{0x43, []int32{99}},
	{0x44, []int32{100}},
